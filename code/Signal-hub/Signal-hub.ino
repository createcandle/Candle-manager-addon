...
#define MY_ENCRYPTION_SIMPLE_PASSWD "yS1hYlh6"      // If you are using the Candle Manager, the password will be changed to what you chose in the interface automatically. Be aware, the length of the password has an effect on memory use.
